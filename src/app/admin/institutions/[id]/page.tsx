...
import { ArrowLeft, Building2, Sparkles, MapPin, Globe, GraduationCap, Image as ImageIcon, Save } from "lucide-react"
...
export default function EditInstitutionPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (error) {
                alert("Error fetching institution: " + error.message)
    ...
    if (fetching) return <div className="py-20 text-center font-bold text-gray-400 uppercase tracking-widest animate-pulse">Syncing Entity...</div>
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 py-6">
            ...
            <div className="flex flex-col gap-2">
                <h2 className="text-3xl font-black tracking-tight text-gray-900 uppercase">Edit Institution</h2>
                <p className="text-gray-500 font-medium">Update the profile and digital presence of this educational entity.</p>
            </div>
                ...
                <CardHeader className="pb-8 border-b border-gray-50 pt-8 px-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <CardTitle className="text-xl font-black text-gray-900">Manage Profile</CardTitle>
                    ...
                    <form onSubmit={handleUpdate} className="space-y-10">
                        <div className="grid gap-8">
                            <div className="space-y-2">
                                <label htmlFor="name" className="text-sm font-bold text-gray-700 ml-1">Full Institution Name</label>
                                <Input id="name" name="name" defaultValue={institution.name} required className="h-12 rounded-2xl border-gray-100 bg-gray-50/50 focus:bg-white transition-all shadow-sm" />
                            </div>
                            ...
                            <div className="grid gap-8 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <select id="type" name="type" defaultValue={institution.type} className="flex h-12 w-full rounded-2xl border border-gray-100 bg-gray-50/50 px-4 py-2 text-sm font-bold text-gray-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-100 transition-all shadow-sm">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="city" name="city" defaultValue={institution.city} required className="h-12 rounded-2xl border-gray-100 bg-gray-50/50 focus:bg-white transition-all shadow-sm" />
                                </div>
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="address" className="text-sm font-bold text-gray-700 ml-1">Street Address</label>
                                <Input id="address" name="address" defaultValue={institution.address} className="h-12 rounded-2xl border-gray-100 bg-gray-50/50 focus:bg-white transition-all shadow-sm" />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="website" name="website" defaultValue={institution.website} className="h-12 rounded-2xl border-gray-100 bg-gray-50/50 focus:bg-white transition-all shadow-sm" />
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid md:grid-cols-[120px_1fr] gap-6 items-center">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-relaxed">Update the visual identity of the institution.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="description" name="description" defaultValue={institution.description} className="min-h-[150px] rounded-2xl border-gray-100 bg-gray-50/50 focus:bg-white transition-all pt-4 shadow-sm" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Button type="submit" disabled={loading} className="h-12 px-10 rounded-2xl font-black bg-primary-600 hover:bg-primary-700 shadow-xl shadow-primary-200 transition-all uppercase tracking-tight text-white border-0">
                                    {loading ? 'Archiving...' : 'Save Changes'}
                                </Button>
                            </div>
                        </div>
                    </form>
