    ...
    return (
        <Card className="border-none shadow-premium bg-white/70 backdrop-blur-xl rounded-3xl overflow-hidden p-2">
            <CardHeader className="space-y-2 pb-8 text-center pt-8">
                <CardTitle className="text-3xl font-black text-gray-900 tracking-tight">Access Success</CardTitle>
                <CardDescription className="text-gray-500 font-medium">
                    Create your student profile to unlock all features.
                </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-6 px-6">
                ...
                <form onSubmit={handleRegister} className="grid gap-5">
                    ...
                    <div className="grid gap-2">
                        <label htmlFor="password" title="At least 6 characters" className="text-sm font-bold text-gray-700 ml-1">Secure Password</label>
                        <Input
                            id="password"
                            type="password"
                            placeholder="••••••••"
            ...
            <CardFooter className="bg-gray-50/10 backdrop-blur-sm border-t border-gray-50 py-8 mt-4">
                <p className="text-center text-sm text-gray-500 w-full font-medium">
                    Already an EduPortal student?{' '}
                    <Link href="/login" className="font-black text-primary-600 hover:text-primary-700 transition-colors decoration-2 underline-offset-4 hover:underline">
                        Sign In Here
                    </Link>
                </p>
            </CardFooter>
